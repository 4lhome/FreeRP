...
namespace FreeRP.Test.Client.LinqMapper
{
    ...
    public class ArrayQuery
    {
        ...
        {
            var c1 = new Queryable<TestModel>().Where(x => x.IntArray.Contains(5));
            ...
            Assert.IsTrue(
                q1.IsMember && q1.Name == "$.IntArray" && q1.MemberType == QueryType.ValueArray &&
        ...
        public void Count()
        {
            var c1 = new Queryable<TestModel>().Where(x => x.IntArray.Count() == 5);
            var qc1 = c1.GetQueries;
        ...
        public void Index()
        {
            var c1 = new Queryable<TestModel>().Where(x => x.IntArray[1] == 5);
            var qc1 = c1.GetQueries;
            Assert.IsTrue(qc1.Count() == 2);
        ...
        public void Length()
        {
            var c1 = new Queryable<TestModel>().Where(x => x.IntArray.Length == 5);
            var qc1 = c1.GetQueries;
            Assert.IsTrue(qc1.Count() == 2);
